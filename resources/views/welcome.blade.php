                        ...
                        @foreach($categories as $category)
                            @if($category->subcategory->count() > 0)
                             <div class="nav-item dropdown">
                                <a class="nav-link" data-toggle="dropdown"" href="#">{{ $category->name }}<i class="fa fa-angle-down float-right mt-1"></i></a>
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item {{$key == 0 ? 'active' : ''}} " style="height: 410px;">
                            <img class="img-fluid" src="{{asset('storage/Banner/' .$banner->image)}}" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">{{$banner->discount_info}}</h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">{{$banner->banner_title}}</h3>
